...
public class StudentUtils {
    ...
    public static void sortByName(List<Student> list) {
        list.sort((o1, o2) -> o1.name.compareTo(o2.name)); //  <--- thay đổi bằng lambda expression
    }
    ...
    {
    	list.sort((o2, o1) -> Integer.compare(o1.age, o2.age));
    }
    ...
    public static double avg(List<Student> list)
    {
    	double sum = list.stream()
                .mapToDouble(student -> (student.math + student.physic + student.english) / 3.0)
                .sum();
